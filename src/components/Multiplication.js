  ...
  const generateQuizQuestions = () => {
    ...
    for (let i = 0; i < numQuestions; i++) {
      ...
      if (difficulty === 'level1') {
        ...
        const level = Math.floor(Math.random() * 3) + 1; // Randomly select from levels 1-3
        if (level === 1) {
          const num1 = Math.floor(Math.random() * 9) + 1;
          const num2 = Math.floor(Math.random() * 9) + 1;
          question = {
          ...
          {!isQuizActive && !isQuizEnded ? (
            <div>
              <div className="mb-3">
                ...
                >
                  <option value="level1">Level 1 (Single-Digit Multiplication)</option>
                  <option value="level2">Level 2 (Two-Digit × One-Digit Multiplication)</option>
                  <option value="level3">Level 3 (Two-Digit × Two-Digit Multiplication)</option>
                  <option value="level4">Level 4 (Mixed Questions)</option>
                </select>
              </div>
